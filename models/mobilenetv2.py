...
class SubMobileNetV2(nn.Module):
    ...
    def __init__(self, num_classes=10):
        ...
        self.layer1 = nn.Sequential(*(self._layers[:3]))
        self.layer2 = nn.Sequential(*(self._layers[3:5]))
        self.layer3 = nn.Sequential(*(self._layers[5:]))
    ...
    def sub_backward(self, targets): 
        ...
        back_var = F.relu(self.bn2(self.conv2(self._inter_var[-2])))
        back_var = F.avg_pool2d(back_var, 4)
        ...
        back_var = F.relu(self.bn1(self.conv1(self._inter_var[-6])))
